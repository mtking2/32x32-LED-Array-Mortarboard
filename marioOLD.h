...
void loadMario(int arg) {
  ...
  switch (arg) {
    case 0: 
      ...
      break;
    case 1: 
      memcpy_P(ptr, mario_walking1, sizeof(mario_walking1));
      break;
    case 2: 
      memcpy_P(ptr, mario_walking2, sizeof(mario_walking3));
      break;
    case 3: 
      memcpy_P(ptr, mario_walking3, sizeof(mario_walking3));
      break;
    case 4: 
      memcpy_P(ptr, mario_flag, sizeof(mario_flag));
      break;
    case 5: 
...
//    //loadMario(4);
//    loadMario(1);
//    //matrix.fillRect(0, 0, fill, 32, matrix.Color333(0, 0, 1));
//    ptr++; fill++;
//    delay(del);
//    //loadMario(4);
//    loadMario(2);
